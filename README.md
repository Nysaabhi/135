...
// Generic search function for all overlays
...
// Generic voice search function for all overlays
function initializeVoiceSearch(inputElement, searchFunction) {
...
function showLocatorsOverlay() {
  ...
  initializeVoiceSearch(exploreInput, (query) => {
    performSearch(locatorsData, query, locatorsGrid, filterButtons, renderLocatorCards);
  });
...
// Function to render platform cards
